...
export const orgs = {
  ...
  getMembers: () => request("/orgs/members").then(r => r.members || []),
  listApiKeys: () => request("/orgs/api-keys").then(r => r.api_keys || []),
...
export const chat = {
  ...
  listSessions: () => request("/ai/sessions").then(r => r.sessions || []),
  getSession: (id: string) => request(`/ai/sessions/${id}/messages`),
};

export const billing = {
  getPlans: () => request("/billing/plans").then(r => r.plans || []),
...
export const agent = {
  ...
  listTasks: () => request("/agent/tasks").then(r => r.tasks || []),
};
...
export const websites = {
  ...
  list: () => request("/websites/").then(r => r.websites || []),
};

export const memory = {
  list: () => request("/memory/").then(r => r.memories || []),
